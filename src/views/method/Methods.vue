<template>
    <div class="p-m-1" style="min-width: 1000px;">
        ...
        <div class="p-d-flex p-jc-between p-m-5">
            <div>
                <Button :label="(allMethods ? 'All Methods' : 'My Methods')" class="p-button-sm p-mr-2" @click="allMethods = !allMethods"/>
                <Button label="Change Display" class="p-button-sm p-mr-2" @click="tableDisplay = !tableDisplay" />
                <Button label="Create Method" icon="pi pi-plus" class="p-button-success p-button-sm" @click="goToMethodCreate()" />
            </div>
