...
<div class="p-grid p-pt-5" style="background-color: #F1F1F1; border: 1px solid #D8D8D8;">
    <div class="p-col-12 p-field">
                ...
                <InputText id="sectiontitle" type="text" v-model.lazy="lazySection.title" />
                ...
                <MultiSelect v-model="selectedQuestions" :options="questions" optionLabel="name" placeholder="Select Questions" class="p-col-12 p-my-2" /> <!--@blur="updateQuestions" :class="{'borderless': questionsErrors.length} -->
